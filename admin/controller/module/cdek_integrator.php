	...
	public function index() {
		...
		foreach ($results as $dispatch_info) {
			...
			$rdata['dispatches'][] = array(
				...
				'cost'					=> (float)$dispatch_info['delivery_cost'] ? $this->currency->format($dispatch_info['delivery_cost']) : 0,
		...
		$rdata['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

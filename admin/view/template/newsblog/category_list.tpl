  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
      	...
      	<!--need to test <a href="<?php echo $repair; ?>" data-toggle="tooltip" title="<?php echo $button_rebuild; ?>" class="btn btn-default"><i class="fa fa-refresh"></i></a> -->
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $column_count_elements; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $category['count_elements']; ?></td>

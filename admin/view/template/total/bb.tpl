            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bb" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="bb_cod_status" id="input-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bb_cod_sort_order" value="<?php echo $bb_cod_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>

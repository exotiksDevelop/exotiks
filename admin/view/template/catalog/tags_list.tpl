...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <a href="<?php echo $settings; ?>" data-toggle="tooltip" title="<?php echo $button_settings; ?>" class="btn btn-primary"><i class="fa fa-cog"></i></a> 
      <a href="<?php echo $group; ?>" data-toggle="tooltip" title="<?php echo $button_group; ?>" class="btn btn-primary"><i class="fa fa-list"></i></a> 
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $tag['count']; ?></td>

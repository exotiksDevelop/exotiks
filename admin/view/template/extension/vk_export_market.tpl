            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td width="150">Категория ВК</td>
                  <td width="150">Подборка ВК</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="left">
                        <?php echo $album['vk_market_category'] ?>
                      </td>
                  <td class="left">
                      <?php if ($album['vk_market_album_id']) { ?>
                        <a href="<?php echo $album['vk_market_album'] ?>" target="_blank"><?php echo $album['vk_market_album'] ?></a>
                      <?php } ?>
                  </td>

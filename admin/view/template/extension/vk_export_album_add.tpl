      ...
      <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" id="form-album" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="vk_album_id" value="<?php echo (isset($this->request->post['vk_album_id']) ? htmlentities($this->request->post['vk_album_id']) : '' ); ?>" placeholder="ссылка на альбом ВК" class="form-control" />
            </div>
          </div>
          
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_owner_type; ?></label>
            <div class="col-sm-10"><?php echo $mode_select?></div>
          </div>

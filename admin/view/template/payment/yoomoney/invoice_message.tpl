                            ...
                            <td style="padding:30px 25px 20px 25px;">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" height="auto" style="border-collapse:collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <span>
                                            <font color="#999999" size="2" face="Arial"><?php echo $language->get('invoice_footer_text')?><a href="https://git.yoomoney.ru/projects/CMS/repos/cms-opencart2" target="_blank" style="font-weight:normal;text-decoration:none;cursor:pointer;">

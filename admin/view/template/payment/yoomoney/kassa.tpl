        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="form-check-label">
                    <input type="radio" name="yoomoney_kassa_payment_mode" value="kassa" id="kassa-payment-mode-kassa" class="form-check-input qa-yookassa-mode"<?php echo $kassa->getEpl() ? ' checked' : ''; ?> />
            ...
            <div class="col-sm-10 col-sm-offset-2" style="padding-bottom: 10px;" id="kassa-payment-mode-kassa-container">
                <label class="form-check-label">
                    <input type="checkbox" name="yoomoney_kassa_use_installments_button" value="on" class="form-check-input qa-order-credit-payment"<?php echo $kassa->useInstallmentsButton() ? ' checked' : ''; ?> />
                ...
                <label class="form-check-label" style="margin-left: 20px;">
                    <input type="checkbox" name="yoomoney_kassa_add_installments_block" value="on"
                           class="form-check-input qa-item-credit-payment"<?php echo $kassa->getAddInstallmentsBlock() ? ' checked' : ''; ?> />
                    <?php echo $language->get('kassa_add_installments_block_label'); ?>
                </label>
            </div>
            <div class="col-sm-10 col-sm-offset-2">
                <label class="form-check-label">
                    <input type="radio" name="yoomoney_kassa_payment_mode" value="shop" id="kassa-payment-mode-shop" class="form-check-input qa-shop-mode"<?php echo $kassa->getEpl() ? '' : ' checked'; ?> />
            ...
            <div class="col-sm-10 col-sm-offset-2" id="kassa-payment-mode-shop-container">
                ...
                <label class="form-check-label">
                    <input type="checkbox" name="yoomoney_<?php echo $name; ?>" value="on" id="kassa-payment-method-<?php echo $id; ?>" class="form-check-input qa-<?= $id; ?>"<?php echo $enabled ? ' checked' : ''; ?> />
                    <?php echo $language->get($name); ?>
                </label><br />
                <?php endforeach; ?>
                <label class="form-check-label" style="margin-left: 20px;">
                    <input type="checkbox" name="yoomoney_kassa_add_installments_block" value="on"
                           class="form-check-input qa-item-card-credit"<?php echo $kassa->getAddInstallmentsBlock() ? ' checked' : ''; ?> />
                    <?php echo $language->get('kassa_add_installments_block_label'); ?>
                </label>

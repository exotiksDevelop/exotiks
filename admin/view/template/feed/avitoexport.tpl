											...
											foreach($categories as $c){
												if(empty($subcategories[$c['category_id']])) echo '<option style="font-style:italic;font-weight:600;" value="' . $c['category_id'] . '">' . $c['name'] . '</option>';
													...
													foreach($subcategories[$c['category_id']] as $sub_c){
														if(empty($subsubcategories[$sub_c['category_id']])) {
															if(!empty($sub_c)){
															...
															foreach($subsubcategories[$sub_c['category_id']] as $subsub){
																echo '<option value="' . $subsub['category_id'] . '"> - ' . $subsub['name'] .' </option>';
															}
														}
													}
													echo "</optgroup>";

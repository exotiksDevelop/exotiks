...
(function (factory) {
  ...
  var Buttons = function (context) {
    ...
    var representShortcut = this.representShortcut = function (editorMethod) {
      ...
      if (agent.isMac) {
        shortcut = shortcut.replace('CMD', 'вЊ').replace('SHIFT', 'в‡§');
      }
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="//summernote.org/" target="_blank">Summernote 0.7.3</a> В· ',
        '<a href="//github.com/summernote/summernote" target="_blank">Project</a> В· ',

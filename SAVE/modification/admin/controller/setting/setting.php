...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['tab_server'] = $this->language->get('tab_server');
                    ...
                    $data['entry_postcalc_key'] = $this->language->get('entry_postcalc_key');
		...
		$data['token'] = $this->session->data['token'];
                    ...
                    if (isset($this->request->post['config_postcalc_key'])) {
                        $data['config_postcalc_key'] = $this->request->post['config_postcalc_key'];
                    } else {
                        $data['config_postcalc_key'] = $this->config->get('config_postcalc_key');
                    }

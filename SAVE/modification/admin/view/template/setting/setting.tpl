...
<li><a href="#tab-bitrix24" data-toggle="tab">Bitrix24</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-postcalc"><?php echo $entry_postcalc_key; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_postcalc_key" value="<?php echo $config_postcalc_key; ?>" id="input-postcalc" class="form-control" />
                        </div>
                    </div>

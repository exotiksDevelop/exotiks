...
<?php if(isset($invoice_kassa)){ ?>
			...
			<button type="button" id="button-b24" form="form-order" formaction="<?php echo $exportListOrder; ?>" data-toggle="tooltip" title="Отправить заказы" class="btn btn-info"><i class="fa fa-paper-plane" aria-hidden="true"></i> Отправить в Битрикс</button>
      ...
      <div class="panel-body">
        ...
        <form method="post" enctype="multipart/form-data" target="_blank" id="form-order">
          <div class="table-responsive">
			...
			<td class="text-left"><?php echo $order['b24_status']; ?></td>

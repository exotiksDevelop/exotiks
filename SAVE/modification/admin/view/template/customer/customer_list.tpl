    ...
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;"><i class="fa fa-trash-o"></i></button>
			...
			<button type="button" id="button-b24" form="form-customer" formaction="<?php echo $exportListCustomer; ?>" data-toggle="tooltip" title="Отправить клиентов" class="btn btn-info"><i class="fa fa-paper-plane" aria-hidden="true"></i> Отправить в Битрикс</button>
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-customer">
          <div class="table-responsive">
			...
			<td class="text-left"><?php echo $customer['b24_status']; ?></td>
...
//--></script> 
  <script type="text/javascript"><!--
			...
			$('#button-b24').on('click', function(e) {

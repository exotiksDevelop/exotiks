...
<div class="simpleregister__simple-content">
<?php } ?>
    ...
    <?php } ?>
    <form class="simpleregister__form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="simplepage_form">

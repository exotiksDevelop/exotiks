...
<div class="container search" id="product_page">
  ...
  <div id="content" class="search__content <?=$class?>">
    ...
    <div class="row search__interface">
      <!-- <label class="filter__label control-label filter__label" for="input-search"><?=$entry_search?></label> -->
      <!-- <div class="col-sm-4"> -->
      <input type="text" name="search" value="<?=$search?>" placeholder="<?=$text_keyword?>"
        id="input-search" class="form-control filter__input" />
      <!-- </div> -->
      <!-- <div class=""> -->
    ...
    <?php if ($products) { ?>
    <!-- <p><a href="<?=$compare?>" id="compare-total" class="search__compare"><?=$text_compare?></a></p> -->
    <div class="row search__interface">
      <!-- <div class=" hidden-xs">
        <div class="btn-group">
          <button type="button" id="list-view" class="button red" data-toggle="tooltip"
            title="<?=$button_list?>"><i class="fa fa-th-list"></i></button>
          <button type="button" id="grid-view" class="button red" data-toggle="tooltip"
            ...
            <? foreach ($products as $product) {
              ...
              <figure class="products__box-item">
                ...
                <span class="products__box-item-bottom">
                  ...
                  <button onclick="cart.add('<?=$product['product_id']?>', '<?=$product['minimum']?>');" type="button" class="products__box-item-btn">

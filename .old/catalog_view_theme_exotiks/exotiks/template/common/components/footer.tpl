...
<div id="footer">
		<div class="rassilka">
			<div class="rassilka_content">
                ...
                <a href="/index.php?route=account/newsletter" class="button podpiska_news">Подписаться</a>
			</div>
		</div>
...
<!-- //Rating@Mail.ru counter -->
            ...
            <div class="col-md-2 col-sm-4  col-xs-12">
                <a href="#myModal" class="button callme" data-toggle="modal" data-target="#myModal">Заказать Звонок</a>
    		</div>

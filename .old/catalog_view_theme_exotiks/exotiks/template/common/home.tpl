...
<section class="ourservice">
  <div class="container">
    ...
    <div class="ourservice__video">
      <!-- <video autoplay muted preload="auto" class="ourservice__video-content"> -->
      <iframe width="100%" height="100%" class="ourservice__video-content" src="https://www.youtube.com/embed/dpbJHyzezUo?autoplay=1&mute=1&showinfo=0&controls=0" frameborder="0" allowfullscreen><!-- ?autoplay=1&mute=1&showinfo=0&controls=0" frameborder="0" allowfullscreen -->
      </iframe>

<ul id="menu">
          ...
          <li id="cdek"><a class="parent"><i class="fa fa-truck fa-fw"></i> <span>СДЭК</span></a>
            <ul>
              <li><a href="<?php echo $cdek_dispatch['link']; ?>"><?php echo $cdek_dispatch['text']; ?></a></li>
              <li><a href="<?php echo $cdek_shipping['link']; ?>"><?php echo $cdek_shipping['text']; ?></a></li>
              <li><a class="parent">Способы оплаты</a>
                <ul>
                  <li><a href="<?php echo $cdek_payment['link']; ?>"><?php echo $cdek_payment['text']; ?></a></li>
                  <li><a href="<?php echo $cdek_total['link']; ?>"><?php echo $cdek_total['text']; ?></a></li>
                </ul>
              </li>
              <li><a class="parent">Другое</a>
                <ul>
                  <li><a href="<?php echo $cdek_license['link']; ?>"><?php echo $cdek_license['text']; ?></a></li>
                  <li><a href="<?php echo $cdek_documentation['link']; ?>" target="_blank"><?php echo $cdek_documentation['text']; ?></a></li>
                  <li><a href="<?php echo $cdek_help['link']; ?>" target="_blank"><?php echo $cdek_help['text']; ?></a></li>
                </ul>
              </li>
            </ul>
          </li>
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $product; ?>"><?php echo $text_product; ?></a></li>
				...
				<li>
					<a class="parent">Wildberries</a>
					<ul>
						<li><a href="<?php echo $wb_product; ?>">Товары Wildberries</a></li>
						<li><a href="<?php echo $wb_product_unattach; ?>">Товары без связей</a></li>
						<li><a href="<?php echo $wb_settings; ?>">Настройки</a></li>
					</ul>
				</li>
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $feed; ?>"><?php echo $text_feed; ?></a></li>
                ...
                <li><a class="parent"><?php echo $text_vk_export; ?></a>
                              <ul>
...
<li><a href="<?php echo $url_redirect; ?>">Url Redirect</a></li>
    </ul>
  </li>
  ...
  <li id="cdl_wildberries"><a class="parent"><i class="fa fa-google-wallet"></i> <span>Wildberries</span></a>
    <ul>
      <li><a href="<?php echo $cdl_wildberries; ?>">Настройки модуля</a></li>
      <li><a href="<?php echo $cdl_orders_wb; ?>">Заказы / Задания WB</a></li>
      <li><a href="<?php echo $cdl_product; ?>">Наши товары</a></li>
      <li><a href="<?php echo $cdl_attributes; ?>">Атрибуты</a></li>
      <li><a href="<?php echo $cdl_rima; ?>">Экспорт товаров</a></li>
      <li><a href="<?php echo $cdl_supplies; ?>">Поставка</a></li>
      <li><a href="<?php echo $cdl_statistics; ?>">Отчеты</a></li>
    </ul>
  </li>
      

  <li id="cdl_ozon_seller"><a class="parent"><i class="fa fa-circle-o fa-fw"></i> <span>Ozon Seller</span></a>
    <ul>
      <li><a href="<?php echo $cdl_ozon_seller; ?>">Настройки модуля</a></li>
      <li><a href="<?php echo $cdl_ozon_seller_product; ?>">Наши товары</a></li>
      <li><a href="<?php echo $cdl_ozon_seller_order; ?>">Заказы Ozon</a></li>
      <li><a href="<?php echo $cdl_ozon_seller_export; ?>">Экспорт товаров</a></li>
			<?php echo (isset($act_ozon)) ? $act_ozon : false; ?>
    </ul>
  </li>

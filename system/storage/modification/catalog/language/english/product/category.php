<?php
			...
			$_['text_date_added_asc']   = 'Newness (Old > New)';
			$_['text_date_added_desc']  = 'Newness (New > Old)';
			$_['text_viewed_asc']   = 'Popularity (Low > High)';
			$_['text_viewed_desc']  = 'Popularity (High > Low)';

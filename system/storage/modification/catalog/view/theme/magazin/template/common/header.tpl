<!DOCTYPE html>
<!--[if IE]><![endif]-->
<!--[if IE 8 ]><html <?php echo $tc_og_prefix; //microdatapro 7.3 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>" class="ie8"><![endif]-->
<!--[if IE 9 ]><html <?php echo $tc_og_prefix; //microdatapro 7.3 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>" class="ie9"><![endif]-->
<!--[if (gt IE 9)|!(IE)]><!-->
<html <?php echo $tc_og_prefix; //microdatapro 7.3 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
<!--<![endif]-->
<head>
<meta charset="UTF-8" />
...
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=776613466003917&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M5TSVV7"
    ...
    <div class="header" >
    		<div class="head1">
    			...
    			<div class="myphone">
    				...
    				<a href="#myModal"  class="btn btn-primary callme" data-toggle="modal" data-target="#myModal">Нужна консультация!</a>
    			</div>
           ...
           <div class=" col-md-2 col-xs-12 col-sm-3">
    			<div class="korzina">
                    ...
                    <span class="link_oform"><a href="/index.php?route=checkout/simplecheckout" title="Перейти в корзину">Оформить заказ</a></span>
           ...
           <div class="col-md-2 col-sm-3 col-xs-12">
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
    			<div class="socseti">
    				...
    				<a rel=”nofollow” target="_blank" href="https://www.youtube.com/channel/UCliH9h1_ydygzbB_z1IIIow" class="youtube"></a>

...
class ModelToolSimpleGeo extends Model {
    ...
    public function getGeoDataByIp($mode) {
        ...
        if (!ModelToolSimpleGeo::$ip_checked) {
            if ($this->progroman_citymanager && $this->progroman_citymanager->setting('integration_simple') && $this->progroman_citymanager->getCityName()) {
    ...
    public function getGeoList($city) {
        ...
        if (!$geo_data) {
            ...
            */
            ...
            if ($this->progroman_citymanager && $this->progroman_citymanager->setting('integration_simple')) {

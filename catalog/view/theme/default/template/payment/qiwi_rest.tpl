...
<?php if ($summ < 15000) { ?>
	<div style="text-align: right;"><?php echo $sub_text_info_phone; ?><input type="text" name="qiwi_phone" value="<?php echo $phone; ?>" size="15" maxlength="15" class="form-control"></div>

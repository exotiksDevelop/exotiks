  ...
  <div class="container">
    ...
    <div id="delivery_box" class="delivery__box">
      ...
      <span class="delivery__box-item">
        ...
        <span class="delivery__box-item-text">
          До пункта выдачи - <span class="green">от 350</span><span class="red"> руб.</span>
          <br>
          Курьерская - <span class="green">от 450</span><span class="red"> руб.</span></span>
      </span>
    </div><!-- /.delivery__box -->
...
<section id="feedback_section" class="feedback">
  <div class="container">
    <h2 class="feedback__title">Клиенты о нас<span>с 2011 года мы получили более трехсот отзывов от наших клиентов</span></h2>
...
<!--<section class="request">
  <div class="container">
    ...
    <br>
       ...
       <a href="https://t.me/Exotiks_bot" id="bottom" class="request__form-btn"><center>Написать в Telegram</center></a> 

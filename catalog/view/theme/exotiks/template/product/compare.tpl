    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php echo $button_cart; ?>" class="button btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="button red"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>

	...
	<div class="row">
		...
		<section class="products products_related">
			<div class="container">
				...
				<h1 class="products__title products__title_related">
					<?= $heading_title; ?>
				</h1>

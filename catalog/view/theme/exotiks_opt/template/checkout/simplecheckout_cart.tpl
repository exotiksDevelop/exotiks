<div class="simplecheckout-block" id="simplecheckout_cart" <?php echo $hide ? 'data-hide="true"' : '' ?>
    <?php echo $has_error ? 'data-error="true"' : '' ?>>
    <?php if ($display_header) { ?>
    <div class="checkout-heading panel-heading" data-id="simplecheckout_cart"><?php echo $text_cart ?></div>
    <?php } ?>
    <?php if ($attention) { ?>
            ...
            <tbody>
                ...
                <tr>
                    <td class="simplecheckout-recurring-product" style="border:none;"><img
                            src="<?php echo $additional_path ?>catalog/view/theme/default/image/reorder.png" alt=""
                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            <span class="input-group-btn">
                                <button class="btn btn-primary custom" data-onclick="decreaseProductQuantity"
                                    data-toggle="tooltip" type="submit">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </span>
                            <input class="form-control" type="text" data-onchange="changeProductQuantity"
                                <?php echo $quantity_step_as_minimum ? 'onfocus="$(this).blur()" data-minimum="' . $product['minimum'] . '"' : '' ?>
                                name="quantity[<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key']; ?>]"
                                value="<?php echo $product['quantity']; ?>" size="1" />
                            <span class="input-group-btn">
                                <button class="btn btn-primary custom" data-onclick="increaseProductQuantity"
                                    data-toggle="tooltip" type="submit">
                                    <i class="fa fa-plus"></i>
                                </button>
                                <button class="btn btn-danger custom" data-onclick="removeProduct"
                                    data-product-key="<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key'] ?>"
                                    data-toggle="tooltip" type="button">
                                    <i class="btn-danger-ico"></i><!-- <i class="fa fa-times-circle"></i> -->
                                </button>
                            </span>
                        </div>
                    </td>
    ...
    <div class="simplecheckout-cart-total" id="entryCoupon">
        <span class="coupon-title">Купон<?//php echo $entry_coupon; ?></span>
        <span class="inputs">
            <input class="form-control" type="text" data-onchange="reloadAll" name="coupon"
            ...
            <!-- <div class="simplecheckout-cart-total simplecheckout-cart-buttons">
                <span class="inputs buttons"> -->
                    <a id="simplecheckout_button_cart" data-onclick="reloadAll"
                        class="coupon-button"><span>Обновить корзину<?//php echo $button_update; ?></span></a>
                    <!-- </span>
            </div> -->
            <?php } ?>
    </div>

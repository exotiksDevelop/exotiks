            ...
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
                        ...
                        <?php } ?>
                        <a class="button red" <?php echo $block_order ? 'disabled' : '' ?> data-onclick="createOrder" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a>
                    </div>
                ...
                <?php } ?>              
            <?php } else { ?>
                <div class="content checkout-error"><?php echo $text_error; ?></div>

...
class CalculatePriceDeliveryCdek {
	...
	private $modeId;
	//эндпоинт запроса к серверу
	private $endpoint = 'calculator/calculate_price_by_json.php';
	...
	public function __construct($initiator = null) {
	     ...
	     if($initiator) {
	     	$this->jsonUrl = $initiator->getInfo()->getAjaxUrl(). $this->endpoint;
	     } else {
	     	$this->jsonUrl = 'https://api.cdek.ru/' . $this->endpoint;
	     }
	}

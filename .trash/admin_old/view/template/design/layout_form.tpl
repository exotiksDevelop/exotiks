            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_slider') { ?>
                    <option value="content_slider" selected="selected">Слайдер</option>
                    <?php } else { ?>
                    <option value="content_slider">Слайдер</option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_akcia') { ?>
                    <option value="content_akcia" selected="selected">Акция</option>
                    <?php } else { ?>
                    <option value="content_akcia">Акция</option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="content_slider">Слайдер</option>';
    html += '    <option value="content_akcia">Акция</option>';
    html += '  </select></td>';

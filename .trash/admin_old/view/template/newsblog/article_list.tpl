            ...
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <select name="filter_category" id="input-status" class="form-control">
                  ...
                  <?php if ($category['article_count'] >= 1) { ?>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $article['date_available']; ?></td>
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/article/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {

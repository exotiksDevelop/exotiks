...
<head>
  ...
  <script src="catalog/view/javascript/dev.js" defer></script>
      ...
      <div class="head1">
        ...
        <div class="container">
          ...
          <div class="head1__city">
            <?= $geoip; ?>
            <div id="geoip-1572333867215" class="geoip-module">
              <div class="geoip-text">
                <span class="geoip-title-zone">Ваш город:</span>
                <span class="zone">Самара</span>
              </div>
            </div>
          </div><!-- /.head1__city -->

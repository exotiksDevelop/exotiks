...
<head>
  ...
  <!-- smmmanager -->
  <noindex>
    <script async src='https://smmfish1.ru/vk_script_activation/?site_id=323' type='text/javascript'></script>
  </noindex>
  <!-- smmmanager -->
...
<body class="<?php echo $class; ?>">
  ...
  <!-- smmmanager -->
  <noindex>
    <script async src='http://smmfish1.ru/vk_script_activation/?site_id=323' type='text/javascript'></script>
  </noindex>
  <!-- smmmanager -->
    ...
    <div class="header">
      <div class="head1">
        ...
        <div class="myphone">
          ...
          <a href="#myModal" class="btn btn-primary callme" data-toggle="modal" data-target="#myModal">Нужна
            консультация!</a>
        </div>

<footer class="footer">
    ...
    <div class="container">
        ...
        <nav class="footer__nav">
            <ul class="footer__nav-list">
                ...
                <li class="footer__nav-list-item"><a href="/index.php?route=information/news">Новости</a></li>
    ...
    <div class="footer__bottom-box">
        <div class="container">
            ...
            <a target="_blank" href="https://vk.com/exotiks_ru" class="footer__bottom-box-link"><i class="ico vk"></i>
                <!-- /.ico vk --></a>
            <!-- /.footer__bottom-box-link -->
            <a target="_blank" href="https://www.instagram.com/exotica.ru/" class="footer__bottom-box-link"><i
                    class="ico inst"></i> <!-- /.ico inst --></a>
            <!-- /.footer__bottom-box-link -->
            <a target="_blank" href="https://www.facebook.com/exotiks.ru/" class="footer__bottom-box-link"><i
                    class="ico fb"></i> <!-- /.ico fb --></a>
            <!-- /.footer__bottom-box-link -->
            <a target="_blank" href="https://www.youtube.com/channel/UCliH9h1_ydygzbB_z1IIIow"
                class="footer__bottom-box-link"><i class="ico tube"></i> <!-- /.ico you --></a>
            <!-- /.footer__bottom-box-link -->
            <a target="_blank" href="https://ok.ru/group/54793255125019" class="footer__bottom-box-link"><i
                    class="ico ok"></i> <!-- /.ico ok --></a>
            <!-- /.footer__bottom-box-link -->
            <a target="_blank" href="https://twitter.com/lianaglina" class="footer__bottom-box-link last"><i
            ...
            <span class="footer__bottom-box-counter"><iframe
                    src="https://yandex.ru/sprav/widget/rating-badge/75933798807" width="150" height="50"
                ...
                <div class="modal-body">
                    <form class="form-block" id="form" role="form">
                        <div class="col-sm-12">
                            ...
                            <input id="bottom" class="btn btn-block" onclick="send();" type="button"
